...
/**
 * @author nguyen duc thanh Contains the configs for AIMS Project
 */
public class Configs {
	...
	public static final String SHIPPING_RUSH_ORDER_SCREEN_PATH = "/views/fxml/shipping_rush_order.fxml";
