...
public class CartScreenHandler extends BaseScreenHandler {
	...
	public void requestToPlaceOrder() throws SQLException, IOException {
		try {
			...
			placeRushOrderController.placRushOrder();
			...
			// hiển thị shippingRushOrder from đã bao gồm cả shipping form
			ShippingRushOrderScreenHandler shippingRushOrderScreenHandler = new ShippingRushOrderScreenHandler(
					this.stage, 
					Configs.SHIPPING_RUSH_ORDER_SCREEN_PATH, 
					order);
			...
			shippingRushOrderScreenHandler.setScreenTitle("Shipping Screen");
