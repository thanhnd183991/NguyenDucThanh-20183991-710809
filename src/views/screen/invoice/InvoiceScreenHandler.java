...
public class InvoiceScreenHandler extends BaseScreenHandler {
	...
	@FXML
	private HBox dateRushOrderHBox;
...
//		System.out.println("Invoice Screen: " + deliveryInfo.toString());
		...
		if (deliveryInfo.get("date") == null || deliveryInfo.get("date") == "") {
			dateRushOrderHBox.setVisible(false);
		} else {
			if (dateRushOrderHBox != null) {
				dateRushOrderHBox.setVisible(true);
				date.setText(Utils.convertDate(deliveryInfo.get("date")));
			}
		}
		...
		invoice.getOrder().getlstOrderMedia().forEach(orderMedia -> {
			try {
				...
				mis.setOrderMedia((OrderMedia) orderMedia, deliveryInfo);
